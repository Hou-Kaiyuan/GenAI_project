"""
experiments with finetuned model (GPT4)
"""
...
ft_model_key='ft:gpt-4o-2024-08-06:personal::AaUNbC4p' # the finetuned model key
client = OpenAI(api_key=api_key)
model = client.fine_tuning.jobs.retrieve(ft_model_key).fine_tuned_model # finetuned model
...
exp_pth='../results/gpt4_finetuned_2d/'
